...
export const dictionaries = {
  pt: {
    ...
    "gallery.subtitle": "Uma seleção da nossa cozinha portuguesa, das sopas às entradas.",
    ...
    "gallery.soupBoard": "Tábua de sopas",
    "gallery.caldoVerde": "Caldo verde",
    "gallery.cheeseBoard": "Tábua de queijo e presunto",
    "gallery.prawns": "Gambas à guilho",
    "gallery.vegetableSoup": "Sopa de legumes",
    "gallery.mushrooms": "Cogumelos crocantes",
    "gallery.peppers": "Pimentos Padrão",
  ...
  en: {
    ...
    "gallery.subtitle": "A selection from our Portuguese kitchen, from soups to starters.",
    ...
    "gallery.soupBoard": "Soup board",
    "gallery.caldoVerde": "Caldo verde",
    "gallery.cheeseBoard": "Cheese and cured ham board",
    "gallery.prawns": "Garlic prawns",
    "gallery.vegetableSoup": "Vegetable soup",
    "gallery.mushrooms": "Crispy mushrooms",
    "gallery.peppers": "Padrón peppers",
  ...
  es: {
    ...
    "gallery.subtitle": "Una selección de nuestra cocina portuguesa, de las sopas a los entrantes.",
    "gallery.interior": "Sala del restaurante",
    "gallery.dish": "Plato de cocina portuguesa",
    "gallery.square": "Centro histórico de Guimarães",
    "gallery.facade": "Ambiente del restaurante",
    "gallery.soupBoard": "Tabla de sopas",
    "gallery.caldoVerde": "Caldo verde",
    "gallery.cheeseBoard": "Tabla de queso y jamón",
    "gallery.prawns": "Gambas al ajillo",
    "gallery.vegetableSoup": "Sopa de verduras",
    "gallery.mushrooms": "Champiñones crujientes",
    "gallery.peppers": "Pimientos de Padrón",
  ...
  fr: {
    ...
    "gallery.subtitle": "Une sélection de notre cuisine portugaise, des soupes aux entrées.",
    ...
    "gallery.soupBoard": "Planche de soupes",
    "gallery.caldoVerde": "Caldo verde",
    "gallery.cheeseBoard": "Planche de fromage et jambon",
    "gallery.prawns": "Crevettes à l'ail",
    "gallery.vegetableSoup": "Soupe de légumes",
    "gallery.mushrooms": "Champignons croustillants",
    "gallery.peppers": "Piments de Padrón",
